...
description: Complete reference for all Redis commands supported by Redis.do, with examples and compatibility notes.
---

# Redis Command Reference

Redis.do implements a comprehensive subset of Redis commands. This reference documents all supported commands with examples and notes on any differences from standard Redis behavior.
